...
//	    JMXUtil.callJMXOperation(jmxInput);
	...
	@Override
	public void updateJob(QuartzInstance instance, Scheduler scheduler, 
			Map<String, Object> jobMap) throws Exception {
	...
	public void pauseTrigger(QuartzInstance quartzInstance, Scheduler scheduler, Trigger trigger) throws Exception {
		JMXInput jmxInput = new JMXInput(quartzInstance, new String[]{"java.lang.String","java.lang.String"}, "pauseTrigger", new Object[]{trigger.getName(), trigger.getGroup()}, scheduler.getObjectName());
	    JMXUtil.callJMXOperation(jmxInput);
	}

	@Override
	public void resumeTrigger(QuartzInstance quartzInstance, Scheduler scheduler, Trigger trigger) throws Exception {
		JMXInput jmxInput = new JMXInput(quartzInstance, new String[]{"java.lang.String","java.lang.String"}, "resumeTrigger", new Object[]{trigger.getName(), trigger.getGroup()}, scheduler.getObjectName());
	    JMXUtil.callJMXOperation(jmxInput);
	}
}